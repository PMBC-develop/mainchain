...
# --kill-count <nod instances to kill>
...
parser.add_argument("--kill-count", type=int, help="nod instances to kill", default=-1)
...
killInstances= not args.dont_kill
...
try:
    ...
    if cluster.killSomeInstances(killCount, killSignal) is False:
        errorExit("Failed to kill  instances")
    Print("nod instances killed.")
    ...
    if cluster.relaunchInstances() is False:
        errorExit("Failed to relaunch  instances")
    Print("nod instances relaunched.")
