...
#include <io/utilities/rand.hpp>
#include <io/chain/genesis_state.hpp>
#include <io/wallet_plugin/wallet.hpp>
#include <io/wallet_plugin/wallet_manager.hpp>

#include <boost/test/unit_test.hpp>
#include <io/chain/authority.hpp>
...
{ try {
   using namespace io::wallet;
   using namespace io::utilities;
...
{ try {
   ...
   constexpr auto key3 = "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"; // io key
   ...
   // io key is imported automatically when a wallet is created
